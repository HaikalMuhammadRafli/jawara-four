...
class BottomNavbar extends StatelessWidget {
    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: [
          ...
          _buildNavItem(Icons.account_balance_wallet_outlined, Icons.account_balance_wallet, 2, context),
  ...
  BottomNavigationBarItem _buildNavItem(IconData outlinedIcon, IconData filledIcon, int index, BuildContext context) {
  ...
  int _getCurrentIndex(BuildContext context) {
    ...
    if (location == '/informasi-aspirasi' || 
        ...
        location == '/daftar-pengguna') return 4;
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMenuTile(context, Icons.supervised_user_circle, 'Daftar Pengguna', 'daftar-pengguna'),
