            ...
            return StreamBuilder<List<Pengeluaran>>(
              ...
              builder: (context, pengeluaranSnapshot) {
                if (pemasukanSnapshot.connectionState ==
                    ...
                    tagihanSnapshot.connectionState ==
                        ConnectionState.waiting ||
                ...
                double totalPemasukan = pemasukanList.fold(
                  0.0,
    ...
    return StreamBuilder<List<Pengeluaran>>(
      ...
      builder: (context, snapshot) {
        ...
        for (var item in pengeluaranList) {
          categoryTotals[item.jenis] =
              (categoryTotals[item.jenis] ?? 0.0) + item.nominal;
      ...
      builder: (context, pemasukanSnapshot) {
        return StreamBuilder<List<Pengeluaran>>(
          ...
          builder: (context, pengeluaranSnapshot) {
            ...
            final double totalPengeluaran = (pengeluaranSnapshot.data ?? [])
